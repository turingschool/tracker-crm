...
#         Contact.create!(first_name: "John", last_name: "Smith", company: "Turing", email: "123@example.com", phone_number: "(123) 555-6789", user_id: user.id)
#       end
...
#   # descirbe "#create action" do
#   #   context "returns a newly created contact" do
#   #     it "should create one contact and return a 201 status code" do

#   #     end
#   #   end

#   #   context "invalid create credentials" do
#   #     it "sho"
#   #   end
#   # end
# end